...
import { ArrowRight, FileText, Image, Layout, Box, Coins } from 'lucide-react';
import { Link } from 'react-router-dom';

const CryptoProof: React.FC = () => {
    return (
            ...
            <div className="container mx-auto px-6 max-w-7xl">
                ...
                <div className="mb-24">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {/* Quidax */}
                        <Link to="/work/quidax-don-jazzy-crypto-education" className="group block relative overflow-hidden rounded-3xl bg-white hover:shadow-2xl transition-all duration-500">
                            <div className="aspect-[16/9] bg-gray-200 relative overflow-hidden">
                                <img src="https://images.unsplash.com/photo-1621416894569-0f39e8462d38?auto=format&fit=crop&q=80" alt="Quidax Case Study" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                                <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
                                <div className="absolute bottom-6 left-6 text-white">
                                    <h3 className="text-3xl font-display font-bold mb-2">Quidax</h3>
                                    <p className="opacity-90 font-medium">Crypto Education at Scale</p>
                                </div>
                            </div>
                        </Link>

                        {/* Zone - Also relevant for crypto/blockchain */}
                    ...
                    <div className="mt-8 flex justify-center">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm text-sm font-medium text-text-muted">
                            ...
                            Adjacent proof: Mercurie digital asset PR
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
                        <div>
                            ...
                            <p className="text-text-muted text-lg">Assets that build trust and drive volume.</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { icon: FileText, title: "Token utility whitepaper", subtitle: "(simplified)" },
                            { icon: Box, title: "Grant program kit", subtitle: "dev acquisition" },
                            { icon: Layout, title: "Exchange listing deck", subtitle: "for liquidity" },
                            { icon: Image, title: "Community memes", subtitle: "viral engagement" },
                        ].map((item, idx) => (
