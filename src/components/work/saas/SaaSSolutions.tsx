...
import { ChevronDown, CheckCircle2, Layout, Sliders, Users, MessageSquare, Zap } from 'lucide-react';

const SaaSSolutions: React.FC = () => {
    const [openIndex, setOpenIndex] = useState<number | null>(0);

    const solutions = [
        {
            title: "Product-Led Growth (PLG) optimization",
            icon: Zap,
            content: {
                playbook: "Optimize the 'aha moment'; build in-app onboarding flows; reduce friction in the signup-to-value path",
                deliverables: "Onboarding audit, email drip sequences, in-app messaging logic",
                kpi: "Improved Activation Rate %"
            }
        },
        {
            ...
            content: {
                playbook: null,
                deliverables: "Pitch decks, competitor battlecards, one-pagers, demo scripts",
                kpi: "Higher Win Rate for Sales"
            }
        },
        {
            ...
            content: {
                playbook: null,
                deliverables: "SEO pillar pages, blog cadence, gated ebooks, newsletter strategy",
                kpi: "Organic Traffic & MQL Growth"
            }
        },
        {
            ...
            content: {
                playbook: null,
                deliverables: "Customer health scoring logic, churn-prevention emails, upsell campaigns",
                kpi: "Increased LTV & Net Revenue Retention (NRR)"
            }
        },
        {
            title: "RevOps & Attribution",
            icon: Sliders,
            content: {
                playbook: null,
                deliverables: "HubSpot/Salesforce cleanup, lead scoring models, full-funnel reporting",
                kpi: "Accurate CAC & Attribution data"
            }
        }
    ];
        ...
        <section className="py-24 bg-white">
            <div className="container mx-auto px-6 max-w-7xl">
                <div className="mb-16">
                    ...
                    <h3 className="text-4xl font-display font-bold text-text-dark">A full-stack growth engine.</h3>
                </div>
