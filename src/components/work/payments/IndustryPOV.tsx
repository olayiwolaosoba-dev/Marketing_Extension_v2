...
const IndustryPOV: React.FC = () => {
    const cards = [
        {
            icon: Target,
            label: 'Market Reality',
            text: 'The best product still loses if trust isn’t packaged.',
        },
        {
            icon: Users,
            label: 'Decision Dynamics',
            text: 'Risk owners influence messaging as much as growth owners.',
        },
        {
            icon: AlertTriangle,
            label: 'What Breaks Growth',
            text: 'Technical value that can’t be repeated by non-technical teams.',
        },
        {
            icon: TrendingUp,
            label: 'What Wins',
            text: 'Proof-led narratives + partner-ready GTM kits + operational cadence.',
        },
    ];
