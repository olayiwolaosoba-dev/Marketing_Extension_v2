...
const SaaSPOV: React.FC = () => {
    const cards = [
        {
            icon: Target,
            label: 'Market Reality',
            text: 'Features don’t sell themselves. Positioning sells the problem you solve.',
        },
        {
            icon: Users,
            label: 'Decision Dynamics',
            text: 'B2B buying is a committee sport. You need to arm your champion to win the room.',
        },
        {
            icon: AlertTriangle,
            label: 'What Breaks Growth',
            text: 'Marketing delivering leads that Sales calls "junk". The disconnect kills ROI.',
        },
        {
            icon: TrendingUp,
            label: 'What Wins',
            text: 'Full-funnel unity. Shared definitions, improved handoffs, and revenue accountability.',
        },
    ];
