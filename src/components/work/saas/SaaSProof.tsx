            ...
            <div className="container mx-auto px-6 max-w-7xl">
                ...
                <div className="mb-24">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {/* SabiTrack */}
                        <Link to="/work/sabitrack-investor-ready-foundation" className="group block relative overflow-hidden rounded-3xl bg-white hover:shadow-2xl transition-all duration-500">
                            <div className="aspect-[16/9] bg-gray-200 relative overflow-hidden">
                                <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80" alt="SabiTrack Case Study" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                                <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
                                <div className="absolute bottom-6 left-6 text-white">
                                    <h3 className="text-3xl font-display font-bold mb-2">SabiTrack</h3>
                                    <p className="opacity-90 font-medium">Investor-Ready Foundation</p>
                                </div>
                            </div>
                        </Link>
                        ...
                        <Link to="/work/tamy-consulting-growth-engine" className="group block relative overflow-hidden rounded-3xl bg-white hover:shadow-2xl transition-all duration-500">
                            <div className="aspect-[16/9] bg-gray-200 relative overflow-hidden">
                                ...
                                <div className="absolute bottom-6 left-6 text-white">
                                    ...
                                    <p className="opacity-90 font-medium">B2B Growth Engine</p>
                                </div>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="mt-8 flex justify-center">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm text-sm font-medium text-text-muted">
                            ...
                            Adjacent proof: VeryPay multi-country marketing bench
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
                        <div>
                            ...
                            <p className="text-text-muted text-lg">Assets that fill the pipeline.</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { icon: FileText, title: "Sales Deck", subtitle: "(that actually converts)" },
                            { icon: Box, title: "Onboarding Email Drip", subtitle: "activation + retention" },
                            { icon: Layout, title: "Landing Page System", subtitle: "high-converting templates" },
                            { icon: Image, title: "LinkedIn Ads Strategy", subtitle: "creative + targeting" },
                        ].map((item, idx) => (
