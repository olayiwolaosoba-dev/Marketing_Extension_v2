            ...
            <div className="container mx-auto px-6 max-w-7xl">
                ...
                <div className="mb-24">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {/* Smartcomply */}
                        <Link to="/work/smartcomply-full-funnel-growth-engine" className="group block relative overflow-hidden rounded-3xl bg-white hover:shadow-2xl transition-all duration-500">
                            <div className="aspect-[16/9] bg-gray-200 relative overflow-hidden">
                                <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80" alt="Smartcomply Case Study" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                                <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
                                <div className="absolute bottom-6 left-6 text-white">
                                    <h3 className="text-3xl font-display font-bold mb-2">Smartcomply</h3>
                                    <p className="opacity-90 font-medium">Compliance Growth Engine</p>
                                </div>
                            </div>
                        </Link>
                        ...
                        <Link to="/work/zone-regulated-blockchain-payments" className="group block relative overflow-hidden rounded-3xl bg-white hover:shadow-2xl transition-all duration-500">
                            <div className="aspect-[16/9] bg-gray-200 relative overflow-hidden">
                                ...
                                <div className="absolute bottom-6 left-6 text-white">
                                    ...
                                    <p className="opacity-90 font-medium">Regulated Payment Infrastructure</p>
                                </div>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="mt-8 flex justify-center">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 shadow-sm text-sm font-medium text-text-muted">
                            ...
                            Adjacent proof: SabiTrack investor-ready foundation
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
                        <div>
                            ...
                            <p className="text-text-muted text-lg">Sales assets that pass legal review.</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { icon: FileText, title: "Capability Statement", subtitle: "(RFP-ready)" },
                            { icon: Box, title: "Trust Center Copy", subtitle: "security assurance" },
                            { icon: Layout, title: "Integration Docs", subtitle: "developer experience" },
                            { icon: Image, title: "Customer Success Stories", subtitle: "ROI validation" },
                        ].map((item, idx) => (
